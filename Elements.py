...
import pyttsx3                                                                                              ## 
import queue                                                                                                ## Imports messagebox from Tkinter for sudedn messages like closing
...
def listenitbackground(): ##This function is called in the thread.
    global chat_value
    global hello_label
    global listening
    listening=1   
...
def maingui():
    ...
    def filter_clicked():
        ...
        if current_img:
            ...
            #emboss button
            img_emboss = Image.open(r"elements2.0Images\assets\filter.png")
...
if __name__ == "__main__":
    ...
    # mixer.init
    splash_img = Image.open(r"elements2.0Images/splashscreen/"+ random_number + ".png")
